...
def on_message(unused_client, unused_userdata, message):
    ...
    elif payload[0:11] == "New token: ":
        with open("deviceTokens.txt", "r") as deviceTokensFile:
            tokens = json.loads(deviceTokensFile)
        tokens["tokens"].append(payload[11:])
        with open("deviceTokens.txt", "w") as deviceTokensFile:
            deviceTokensFile.write(json.dumps(tokens))
